...
let questions = document.querySelectorAll(".funds .question");
let questionImgs = document.querySelectorAll(".funds .question img");

questions.forEach((question) => {
  question.onclick = () => {
    document.querySelectorAll(".funds .answer").forEach((article) => {
      article.style.display = "none";
    });
    document.querySelector(`.funds ${question.dataset.class}`).style.display = "flex";
